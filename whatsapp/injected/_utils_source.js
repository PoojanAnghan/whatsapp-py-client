...
exports.LoadUtils = () => {
    ...
    window.WWebJS.sendMessage = async (chat, content, options = {}) => {
        ...
        const msg = window.require('WAWebCollections').Msg.get(newMsgKey._serialized);
    ...
    window.WWebJS.editMessage = async (msg, content, options = {}) => {
        ...
        return window.WWebJS.getMessageModel(editedMsg);
    };
    ...
    window.WWebJS.getMessageModel = (message) => {
        ...
        if (msg.buttons) msg.buttons = msg.buttons.serialize();
        ...
        // PRUNING: Kill deep recursion in quoted messages
        if (msg.quotedMsg) {
            msg.quotedMsg = {
    ...
    window.WWebJS.getChatModel = async (chat, { isChannel = false } = {}) => {
        ...
        // PRUNING: Kill deep recursion in lastMessage
    ...
    window.WWebJS.logout = async () => {
        return await window.require('WAWebLogoutAction').logoutAll();
    };
};
